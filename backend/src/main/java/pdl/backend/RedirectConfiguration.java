  ...
  public class RedirectConfiguration {
      ...
      private OncePerRequestFilter createRedirectFilter() {
          return new OncePerRequestFilter() {
              // Forwards all routes except '/index.html', '/200.html', '/favicon.ico', '/sw.js' '/images/', '/images/**', '/auth/**'
              private final String REGEX = "(?!/actuator|/images|/_nuxt|/static|/auth|/index\\.html|/200\\.html|/favicon\\.ico|/sw\\.js).*$";
